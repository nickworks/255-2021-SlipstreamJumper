...
namespace Miller
{
    public class AABB : MonoBehaviour
    {
        ...
        /// or the size of the collider changes.
        /// </summary>
        ...
        public bool OverlapCheck(AABB other)
        {
            ...
            if (other.max.z < this.min.z) return false; // gap "backward" - NO COLLISION
        ...
        public Vector3 FindFix(AABB other)
        {
            ...
            float moveRight = other.max.x - this.min.x; // positibe number
